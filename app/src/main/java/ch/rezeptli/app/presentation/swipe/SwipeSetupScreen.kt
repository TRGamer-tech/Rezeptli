...
fun SwipeSetupRoute(
    ...
    onStartTogether: (RecipeFilter) -> Unit,
    ...
    SwipeSetupScreen(
        ...
        onStartTogether = { onStartTogether(uiState.filter) },
    )
}
...
fun SwipeSetupScreen(
    ...
    Scaffold(
        ...
        topBar = {
            RezeptliTopBar(
                title = stringResource(R.string.swipe_setup_title),
                onBack = onBack,
            )
        },
    ) { innerPadding ->
        Column(
            ...
            // Der gemeinsame Modus steht gleichberechtigt daneben und nicht in einem
            // Menue: Er war bisher nirgends zu finden, und genau das war das Problem.
            OutlinedButton(
                ...
                Text(text = "  " + stringResource(R.string.mehrspieler_starten))
            }
